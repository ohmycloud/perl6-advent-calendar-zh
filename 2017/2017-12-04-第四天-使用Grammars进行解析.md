...
让我们来看一下 TadeuszSośnierz 写的 Perl 6 模块 [Config::INI](https://github.com/tadzik/perl6-Config-INI)。 它包含以下 [grammar](https://github.com/tadzik/perl6-Config-INI/blob/master/lib/Config/INI.pm)（这儿稍微重新格式化了）：
