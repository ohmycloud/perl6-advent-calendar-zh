== link:https://perl6advent.wordpress.com/2017/12/17/something-about-messaging-but-i-couldnt-think-of-a-snappier-title/[第十七天-关于消息传递]
...
有相当多的自由和商业管理消息系统，使用一系列开放和专有的协议，但我将限制自己到我熟悉的 link:https://www.rabbitmq.com/[RabbitMQ]，并且在 Perl 6 中由 link:https://github.com/retupmoca/P6-Net-AMQP[Net::AMQP] 支持。
...
在输入第一段之后，我总结道，在一篇短文中，我永远无法做到这个主题正义，所以我希望你认为这是一个开胃菜，我不认为我会永远找到时间来写书，它可能值得。但是我确实有基于 link:https://github.com/jonathanstowe/Perl6-RMQ-Examples[RabbitMQ 教程]的所有示例，因此请检查并随意贡献。
