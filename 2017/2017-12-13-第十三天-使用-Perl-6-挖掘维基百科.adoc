...
欲了解更多信息, 请查看: link:https://docs.perl6.org/language/grammars[https://docs.perl6.org/language/grammars]
...
!link:https://perl6advent.files.wordpress.com/2017/11/perl6infobox.png[img]
...
然后，让我们开始解析 link:https://ja.wikipedia.org/wiki/Perl_6[Perl 6 文章]中的信息框！
...
- 问题 1.1 的解决方法：
 - 创建 token *value-content-list-nl*，它是 value-content-list token 的换行符分隔版本。使用link:https://docs.perl6.org/language/regexes#Modified_quantifier:_%,_%%[修改量词] `％` 来表示这种序列是很有用的。 （＃1）
