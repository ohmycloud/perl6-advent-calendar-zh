...
在link:https://perl6.github.io/6pad/#baa305eff795ed1f7a1957b83a9d4b26[浏览器]中运行此代码。 你将不得不等待几秒钟来获得当前相当大的perl6编译器在javascript中。
...
这里是link:https://perl6.github.io/6pad/#cb1856d301959e3d3dca95925eab2bee[6pad]的链接，您可以在浏览器中试用它。

第三，这是我的机器的截图，以防您在移动设备上阅读或其他无法运行perl6的内容。

!link:https://perl6advent.files.wordpress.com/2018/12/fish-tmp_112.png[img]
...
!link:https://perl6advent.files.wordpress.com/2018/12/fish-tmp_113.png[img]

这是试用它的 link:https://perl6.github.io/6pad/#98c06c9c9aafaf36c9c4fbf320d9c9cc[6pad]
...
!link:https://perl6advent.files.wordpress.com/2018/12/fish-tmp_114.png[img]
